...
const ClothingBrandsPricingSection = () => {
  return (
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-secondary/50 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-accent">CLOTHING BRANDS PRICING</span>
          </div>
...
export default ClothingBrandsPricingSection;